...
const Brand = () => {
  return (
    <>
      <section>
        <div className="w-[1440px] h-[355px] px-4 md:px-8 py-2 text-[#2A254B] mt-4">
          {/* Title */}
          ...
          {/* Features */}
          <div className="flex flex-col md:flex-row gap-4 mt-12 text-base md:text-lg">
            {/* Feature 1 */}
            <div className="flex flex-col md:w-[22%] p-4 rounded-lg bg-gray-200 px-12 py-12">
            ...
            {/* Feature 4 */}
            <div className="flex flex-col md:w-[22%] p-2 rounded-lg bg-gray-200 px-12 py-12">
